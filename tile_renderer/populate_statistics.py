...
if __name__ == '__main__':
    ...
    print 'Loading statistics ("." = 1000 stats)...',

    read_cursor.execute('SELECT region_id, indicator_id, year, value_integer, value_float, note FROM indicator_region_values')
    regions = {}
    n = 0
    ...
    print 'Writing statistics ("." = 1000 regions)...',
    n = 0
